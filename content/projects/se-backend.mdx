---
title: SE-Backend
description: A web app for streamlined team coordination and project management, utilizing MongoDB with Prisma ORM for efficient database handling and AWS S3 for scalable photo storage. It's deployed on Amazon EC2, leveraging Docker Compose for container orchestration, NGINX for load balancing, and GitHub Actions for continuous integration and deployment, ensuring a seamless workflow from development to production.
date: "2023-04-25"
published: true
repository: Jarviss77/se-backend
---
